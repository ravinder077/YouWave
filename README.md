...
<h2 align="center"><b>BlackTube</b></h2>
...
<hr />
WARNING: PUTTING BlackTube OR ANY FORK OF IT INTO GOOGLE PLAYSTORE VIOLATES THEIR TERMS OF CONDITIONS.
...
BlackTube does not use any Google framework libraries, or the YouTube API. It only parses the website in order to gain the information it needs. Therefore this app can be used on devices without Google Services installed. Also, you don't need a YouTube account to use BlackTube, and it's FLOSS.
...
Although BlackTube only supports YouTube at the moment, it's designed to support many more streaming services. The plan is, that BlackTube will get such support by the version 2.0.
...
## Donate
If you like BlackTube we'd be happy about a donation. You can either donate via Bitcoin or BountySource. For further information about donating to BlackTube, please visit our [website](https://newpipe.schabi.org/donate/).
...
BlackTube is Free Software: You can use, study share and improve it at your
