...
import com.tuespotsolutions.blacktube.BuildConfig;
...
import com.tuespotsolutions.blacktube.player.event.PlayerEventListener;
import com.tuespotsolutions.blacktube.player.helper.LockManager;
import com.tuespotsolutions.blacktube.playlist.PlayQueueItem;
import com.tuespotsolutions.blacktube.util.ListHelper;
import com.tuespotsolutions.blacktube.util.NavigationHelper;
import com.tuespotsolutions.blacktube.util.ThemeHelper;

import static com.tuespotsolutions.blacktube.player.helper.PlayerHelper.getTimeString;
...
public final class BackgroundPlayer extends Service {
    ...
    public static final String ACTION_CLOSE = "com.tuespotsolutions.blacktube.player.BackgroundPlayer.CLOSE";
    public static final String ACTION_PLAY_PAUSE = "com.tuespotsolutions.blacktube.player.BackgroundPlayer.PLAY_PAUSE";
    public static final String ACTION_OPEN_CONTROLS = "com.tuespotsolutions.blacktube.player.BackgroundPlayer.OPEN_CONTROLS";
    public static final String ACTION_REPEAT = "com.tuespotsolutions.blacktube.player.BackgroundPlayer.REPEAT";
    public static final String ACTION_PLAY_NEXT = "com.tuespotsolutions.blacktube.player.BackgroundPlayer.ACTION_PLAY_NEXT";
    public static final String ACTION_PLAY_PREVIOUS = "com.tuespotsolutions.blacktube.player.BackgroundPlayer.ACTION_PLAY_PREVIOUS";
    public static final String ACTION_FAST_REWIND = "com.tuespotsolutions.blacktube.player.BackgroundPlayer.ACTION_FAST_REWIND";
    public static final String ACTION_FAST_FORWARD = "com.tuespotsolutions.blacktube.player.BackgroundPlayer.ACTION_FAST_FORWARD";
    ...
    String inter = MainActivity.inter;
    String banner = MainActivity.banner;
    ...
    private void onScreenOnOff(boolean on) {
        ...
        System.err.println("onScreenOnOff called");
        interstitialAd1 = new InterstitialAd(BackgroundPlayer.this);
    ...
    private NotificationCompat.Builder createNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) builder.setPriority(NotificationCompat.PRIORITY_MAX);
        return builder;
    }
